...
{
    public class ZH_L17B : ZH_L16
    {
        /// <summary>
        /// Note that A cofficnet is convert from bar to msw
        /// This is for Buhlmann ZHL-16B with the 1a halftimes + tissue 0
        /// </summary>
        public ZH_L17B()
        {
            ...
            comp.SetCompartmentTimeConstants(0.75, 2.0, 5.000, 0.600, 3.000, 0.830);
            comp.SetPartialPressure(0, ppN2Start);
            comp.SetM0Value(32.4);
            Compartments.Add(comp);
            // comp 1
            comp = new ZH_Compartment();
            comp.SetCompartmentTimeConstants(1.51, 4.0, 17.424, 0.4245, 12.2599, 0.5050);
            comp.SetPartialPressure(0, ppN2Start);
            comp.SetM0Value(32.4);
            Compartments.Add(comp);
            // comp 2
            ...
            // comp 8
            comp = new ZH_Compartment();
            comp.SetCompartmentTimeConstants(29.11, 77.0, 6.502, 0.8553, 4.500, 0.8910);
            comp.SetPartialPressure(0, ppN2Start);
